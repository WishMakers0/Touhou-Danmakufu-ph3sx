...
protected:
	...
	gstd::ref_count_ptr<ManagedScript> ptrPlayerScript_;
	gstd::ref_count_ptr<ManagedScript> ptrItemScript_;
	gstd::ref_count_ptr<ManagedScript> ptrShotScript_;
public:
	...
	void SetPlayerScript(gstd::ref_count_ptr<ManagedScript> id);
	void SetItemScript(gstd::ref_count_ptr<ManagedScript> id);
	void SetShotScript(gstd::ref_count_ptr<ManagedScript> id);
	gstd::ref_count_ptr<ManagedScript> GetPlayerScript() { return ptrPlayerScript_; }
	gstd::ref_count_ptr<ManagedScript> GetItemScript() { return ptrItemScript_; }
	gstd::ref_count_ptr<ManagedScript> GetShotScript() { return ptrShotScript_; }
};
...
public:
	...
	static gstd::value Func_GetPlayerAutoItemCollectLine(gstd::script_machine* machine, int argc, gstd::value const * argv);
	...
	static gstd::value Func_SetPlayerItemScope(gstd::script_machine* machine, int argc, gstd::value const * argv);
	static gstd::value Func_GetPlayerItemScope(gstd::script_machine* machine, int argc, gstd::value const * argv);
	...
	static gstd::value Func_ObjShot_SetDeleteLife(gstd::script_machine* machine, int argc, gstd::value const * argv);
	...
	static gstd::value Func_ObjShot_GetIntersectionEnable(gstd::script_machine* machine, int argc, gstd::value const * argv);
	...
	static gstd::value Func_ObjShot_SetIntersectionScaleX(gstd::script_machine* machine, int argc, gstd::value const * argv);
	static gstd::value Func_ObjShot_SetIntersectionScaleY(gstd::script_machine* machine, int argc, gstd::value const * argv);
	static gstd::value Func_ObjShot_SetIntersectionScaleXY(gstd::script_machine* machine, int argc, gstd::value const * argv);
	...
	static gstd::value Func_ObjStLaser_SetPermitExpand(gstd::script_machine* machine, int argc, gstd::value const * argv);
	static gstd::value Func_ObjStLaser_GetPermitExpand(gstd::script_machine* machine, int argc, gstd::value const * argv);
