...
gstd::value StgStageScript::Func_GetPlayerAutoItemCollectLine(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	StgStageController* stageController = script->stageController_;
	ref_count_ptr<StgPlayerObject>::unsync obj = stageController->GetPlayerObject();
	if (obj == nullptr)return value();
...
gstd::value StgStageScript::Func_SetPlayerItemScope(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	StgStageController* stageController = script->stageController_;
	ref_count_ptr<StgPlayerObject>::unsync obj = stageController->GetPlayerObject();
	if (obj == nullptr)return value();
...
gstd::value StgStageScript::Func_GetPlayerItemScope(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	StgStageController* stageController = script->stageController_;
	ref_count_ptr<StgPlayerObject>::unsync obj = stageController->GetPlayerObject();
...
gstd::value StgStageScript::Func_ObjShot_SetDeleteLife(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = (int)argv[0].as_real();
	StgShotObject* obj = dynamic_cast<StgShotObject*>(script->GetObjectPointer(id));
	if (obj == nullptr)return value();
...
gstd::value StgStageScript::Func_ObjShot_GetIntersectionEnable(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	StgStageController* stageController = script->stageController_;
	int id = (int)argv[0].as_real();
	StgShotObject* obj = dynamic_cast<StgShotObject*>(script->GetObjectPointer(id));
...
gstd::value StgStageScript::Func_ObjShot_SetIntersectionScaleX(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	StgStageController* stageController = script->stageController_;
	int id = (int)argv[0].as_real();
	StgShotObject* obj = dynamic_cast<StgShotObject*>(script->GetObjectPointer(id));
...
gstd::value StgStageScript::Func_ObjShot_SetIntersectionScaleY(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	StgStageController* stageController = script->stageController_;
	int id = (int)argv[0].as_real();
	StgShotObject* obj = dynamic_cast<StgShotObject*>(script->GetObjectPointer(id));
...
gstd::value StgStageScript::Func_ObjShot_SetIntersectionScaleXY(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	StgStageController* stageController = script->stageController_;
	int id = (int)argv[0].as_real();
	StgShotObject* obj = dynamic_cast<StgShotObject*>(script->GetObjectPointer(id));
...
gstd::value StgStageScript::Func_ObjStLaser_SetPermitExpand(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = (int)argv[0].as_real();
	StgStraightLaserObject* obj = dynamic_cast<StgStraightLaserObject*>(script->GetObjectPointer(id));
	if (obj == nullptr)return value();
...
gstd::value StgStageScript::Func_ObjStLaser_GetPermitExpand(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	StgStageScript* script = (StgStageScript*)machine->data;
	int id = (int)argv[0].as_real();
	StgStraightLaserObject* obj = dynamic_cast<StgStraightLaserObject*>(script->GetObjectPointer(id));
	if (obj == nullptr)return value();
