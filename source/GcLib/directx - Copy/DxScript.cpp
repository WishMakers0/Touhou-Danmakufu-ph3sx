...
gstd::value DxScript::Func_MatrixIdentity(gstd::script_machine* machine, int argc, value const * argv) {
...
gstd::value DxScript::Func_MatrixInverse(gstd::script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
...
gstd::value DxScript::Func_MatrixAdd(gstd::script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
...
gstd::value DxScript::Func_MatrixSubtract(gstd::script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
...
gstd::value DxScript::Func_MatrixMultiply(gstd::script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
...
gstd::value DxScript::Func_MatrixDivide(gstd::script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
...
gstd::value DxScript::Func_MatrixTranspose(gstd::script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
...
gstd::value DxScript::Func_MatrixDeterminant(gstd::script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
...
gstd::value DxScript::Func_MatrixLookatLH(gstd::script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
...
gstd::value DxScript::Func_MatrixLookatRH(gstd::script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
...
value DxScript::Func_LoadTextureEx(script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	bool res = true;
	std::wstring path = argv[0].as_string();
...
value DxScript::Func_LoadTextureInLoadThreadEx(script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	bool res = true;
	std::wstring path = argv[0].as_string();
	bool useMipMap = argv[1].as_boolean();
...
gstd::value DxScript::Func_ResetRenderTarget(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
...
gstd::value DxScript::Func_ClearRenderTargetA1(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	TextureManager* textureManager = TextureManager::GetBase();
...
gstd::value DxScript::Func_ClearRenderTargetA2(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	TextureManager* textureManager = TextureManager::GetBase();
...
gstd::value DxScript::Func_ClearRenderTargetA3(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	TextureManager* textureManager = TextureManager::GetBase();
...
gstd::value DxScript::Func_SaveRenderedTextureA3(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
...
value DxScript::Func_GetCameraWVPMatrix(script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	DirectGraphics* graphics = DirectGraphics::GetBase();
	IDirect3DDevice9* device = graphics->GetDevice();
...
gstd::value DxScript::Func_GetObjectDistance(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	...
	double res = sqrt(tx * tx + ty * ty + tz * tz);
	return value(machine->get_engine()->get_real_type(), res);
}
...
value DxScript::Func_ObjRender_GetColor(script_machine* machine, int argc, value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	int id = (int)argv[0].as_real();
	DxScriptRenderObject* obj = dynamic_cast<DxScriptRenderObject*>(script->GetObjectPointer(id));
	if (obj == NULL)return value();
	...
	vecColor.push_back((double)ColorAccess::GetColorR(color));
	vecColor.push_back((double)ColorAccess::GetColorG(color));
	vecColor.push_back((double)ColorAccess::GetColorB(color));
...
value DxScript::Func_ObjRender_GetAlpha(script_machine* machine, int argc, value const * argv) {
	double res = 0;
	DxScript* script = (DxScript*)machine->data;
	int id = (int)argv[0].as_real();
	DxScriptRenderObject* obj = dynamic_cast<DxScriptRenderObject*>(script->GetObjectPointer(id));
...
value DxScript::Func_ObjRender_SetTextureFilterMin(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	int id = (int)argv[0].as_real();
...
value DxScript::Func_ObjRender_SetTextureFilterMag(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	int id = (int)argv[0].as_real();
	int type = (int)(argv[1].as_real() + 0.01);
...
value DxScript::Func_ObjRender_SetTextureFilterMip(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	int id = (int)argv[0].as_real();
	int type = (int)(argv[1].as_real() + 0.01);
...
value DxScript::Func_ObjPrimitive_GetPrimitiveType(script_machine* machine, int argc, value const * argv) {
	double res = 0;
	DxScript* script = (DxScript*)machine->data;
	int id = (int)argv[0].as_real();
	DxScriptPrimitiveObject* obj = dynamic_cast<DxScriptPrimitiveObject*>(script->GetObjectPointer(id));
...
gstd::value DxScript::Func_ObjSpriteList2D_SetAutoClearVertexCount(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	int id = (int)argv[0].as_real();
	DxScriptSpriteListObject2D* obj = dynamic_cast<DxScriptSpriteListObject2D*>(script->GetObjectPointer(id));
	if (obj == NULL)return value();
	...
	obj->GetSpritePointer()->SetAutoClearVertex(bClear);
...
gstd::value DxScript::Func_ObjFileB_WriteBoolean(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	...
	DWORD res = buffer->Write(&data, sizeof(bool));
	return value(machine->get_engine()->get_real_type(), (double)res);
}
gstd::value DxScript::Func_ObjFileB_WriteByte(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	...
	DWORD res = buffer->Write(&data, sizeof(byte));
	return value(machine->get_engine()->get_real_type(), (double)res);
}
gstd::value DxScript::Func_ObjFileB_WriteShort(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	...
	DWORD res = buffer->Write(&data, sizeof(int16_t));
	return value(machine->get_engine()->get_real_type(), (double)res);
}
gstd::value DxScript::Func_ObjFileB_WriteInteger(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	...
	DWORD res = buffer->Write(&data, sizeof(int32_t));
	return value(machine->get_engine()->get_real_type(), (double)res);
}
gstd::value DxScript::Func_ObjFileB_WriteLong(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	...
	DWORD res = buffer->Write(&data, sizeof(int64_t));
	return value(machine->get_engine()->get_real_type(), (double)res);
}
gstd::value DxScript::Func_ObjFileB_WriteFloat(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	...
	DWORD res = buffer->Write(&data, sizeof(float));
	return value(machine->get_engine()->get_real_type(), (double)res);
}
gstd::value DxScript::Func_ObjFileB_WriteDouble(gstd::script_machine* machine, int argc, gstd::value const * argv) {
	DxScript* script = (DxScript*)machine->data;
	...
	DWORD res = buffer->Write(&data, sizeof(double));
	return value(machine->get_engine()->get_real_type(), (double)res);
}
