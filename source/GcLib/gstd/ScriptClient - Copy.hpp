...
namespace gstd {
	...
	**********************************************************/
	...
	public:
		...
		static value Func_SinCos(script_machine* machine, int argc, value const * argv);

		static value Func_RCos(script_machine* machine, int argc, value const * argv);
		static value Func_RSin(script_machine* machine, int argc, value const * argv);
		static value Func_RTan(script_machine* machine, int argc, value const * argv);
		static value Func_RSinCos(script_machine* machine, int argc, value const * argv);
		...
		static value Func_Exp(script_machine* machine, int argc, value const * argv);

		static value Func_Rand(script_machine* machine, int argc, value const * argv);
		static value Func_RandEff(script_machine* machine, int argc, value const * argv);
		static value Func_Sqrt(script_machine* machine, int argc, value const * argv);

		static value Func_Interpolate_Linear(script_machine* machine, int argc, value const * argv);
		static value Func_Interpolate_Smooth(script_machine* machine, int argc, value const * argv);
		static value Func_Interpolate_Smoother(script_machine* machine, int argc, value const * argv);
		static value Func_Interpolate_Accelerate(script_machine* machine, int argc, value const * argv);
		static value Func_Interpolate_Decelerate(script_machine* machine, int argc, value const * argv);
		static value Func_Interpolate_Modulate(script_machine* machine, int argc, value const * argv);
		static value Func_Interpolate_Overshoot(script_machine* machine, int argc, value const * argv);
		static value Func_Interpolate_QuadraticBezier(script_machine* machine, int argc, value const * argv);
		static value Func_Interpolate_CubicBezier(script_machine* machine, int argc, value const * argv);

		static value Func_TypeOf(script_machine* machine, int argc, value const * argv);
		static value Func_FTypeOf(script_machine* machine, int argc, value const * argv);
		...
		static value Func_DeleteAreaCommonDataAll(script_machine* machine, int argc, value const * argv);
