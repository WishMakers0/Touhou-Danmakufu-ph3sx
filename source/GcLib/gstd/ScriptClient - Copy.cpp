...
value ScriptClientBase::CreateRealValue(double r) {
	...
	value res(typeManager->get_real_type(), r);
	return res;
}
...
value ScriptClientBase::Func_SinCos(script_machine* machine, int argc, value const * argv) {
...
value ScriptClientBase::Func_RCos(script_machine* machine, int argc, value const * argv) {
	return value(machine->get_engine()->get_real_type(), (double)cos(argv[0].as_real()));
}
value ScriptClientBase::Func_RSin(script_machine* machine, int argc, value const * argv) {
	return value(machine->get_engine()->get_real_type(), (double)sin(argv[0].as_real()));
}
value ScriptClientBase::Func_RTan(script_machine* machine, int argc, value const * argv) {
	return value(machine->get_engine()->get_real_type(), (double)tan(argv[0].as_real()));
}
value ScriptClientBase::Func_RSinCos(script_machine* machine, int argc, value const * argv) {
	ScriptClientBase* script = reinterpret_cast<ScriptClientBase*>(machine->data);
...
value ScriptClientBase::Func_Exp(script_machine* machine, int argc, value const * argv) {
...
value ScriptClientBase::Func_RandEff(script_machine* machine, int argc, value const * argv) {
	ScriptClientBase* script = reinterpret_cast<ScriptClientBase*>(machine->data);
	double min = argv[0].as_real();
	double max = argv[1].as_real();
...
value ScriptClientBase::Func_Sqrt(script_machine* machine, int argc, value const * argv) {
...
value ScriptClientBase::Func_Interpolate_Linear(script_machine* machine, int argc, value const * argv) {
...
value ScriptClientBase::Func_Interpolate_Smooth(script_machine* machine, int argc, value const * argv) {
	double a = argv[0].as_real();
	double b = argv[1].as_real();
	double x = argv[2].as_real();
...
value ScriptClientBase::Func_Interpolate_Smoother(script_machine* machine, int argc, value const * argv) {
	double a = argv[0].as_real();
	double b = argv[1].as_real();
	double x = argv[2].as_real();
...
value ScriptClientBase::Func_Interpolate_Accelerate(script_machine* machine, int argc, value const * argv) {
	double a = argv[0].as_real();
	double b = argv[1].as_real();
	double x = argv[2].as_real();
...
value ScriptClientBase::Func_Interpolate_Decelerate(script_machine* machine, int argc, value const * argv) {
	double a = argv[0].as_real();
	double b = argv[1].as_real();
	double x = argv[2].as_real();
...
value ScriptClientBase::Func_Interpolate_Modulate(script_machine* machine, int argc, value const * argv) {
	double a = argv[0].as_real();
	double b = argv[1].as_real();
...
value ScriptClientBase::Func_Interpolate_Overshoot(script_machine* machine, int argc, value const * argv) {
	double a = argv[0].as_real();
	double b = argv[1].as_real();
	double c = argv[2].as_real();
	double x = argv[3].as_real();
...
value ScriptClientBase::Func_Interpolate_QuadraticBezier(script_machine* machine, int argc, value const * argv) {
	double a = argv[0].as_real();
	double b = argv[1].as_real();
	double c = argv[2].as_real();
	double x = argv[3].as_real();
...
value ScriptClientBase::Func_Interpolate_CubicBezier(script_machine* machine, int argc, value const * argv) {
	double a = argv[0].as_real();
	double b = argv[1].as_real();
...
value ScriptClientBase::Func_TypeOf(script_machine* machine, int argc, value const * argv) {
...
value ScriptClientBase::Func_FTypeOf(script_machine* machine, int argc, value const * argv) {
	const value token = argv[0];
...
value ScriptClientBase::Func_DeleteAreaCommonDataAll(script_machine* machine, int argc, value const * argv) {
	ScriptClientBase* script = reinterpret_cast<ScriptClientBase*>(machine->data);
	ScriptCommonDataManager* commonDataManager = script->GetCommonDataManager();
